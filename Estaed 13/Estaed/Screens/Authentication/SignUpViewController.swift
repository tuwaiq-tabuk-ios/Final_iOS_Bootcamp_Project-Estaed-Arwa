...
class SignUpViewController : UIViewController,UITextFieldDelegate{
  ...
  func validateFields() -> String? {
   ...
   if  Utilities.isPasswordValid(cleanedPassword) == false {
    ...
    return NSLocalizedString( "pleas make sure your password is at least 8 characters, contains a special characters and a number.", comment: "")
        bottomLine.backgroundColor = UIColor.init(red: 155/255, green: 0/255, blue: 0/255, alpha: 1).cgColor
    }
    return nil
  }
      ...
      showError(error!)
        ...
        Auth.auth().createUser(withEmail: email, password: password) { (result ,err)  in
          ...
          if err != nil {
            ...
            self.showError(NSLocalizedString("Error creating user", comment: "") )
  ...
  //
            ...
            if error != nil{             // -------------------------------------------
              //show error message
              self.showError(NSLocalizedString("Error saving user data", comment:""))
            }
          }
