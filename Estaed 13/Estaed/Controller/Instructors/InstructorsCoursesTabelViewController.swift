...
class InstructorsCoursesTabelViewController : UIViewController {
  ...
  func getCourses()
  {
    ...
    self.ref.observe(.value) { dataSnapShot in
      ...
      {
        Constant.getMsg(title: NSLocalizedString("Error!", comment: ""), Msg: NSLocalizedString("error while Getting Data", comment: ""), context: self)
   ...
   -> UISwipeActionsConfiguration? {
     let delete = UIContextualAction(style: .destructive,
                                     title: NSLocalizedString("Delete", comment: "")) { ACTION,
                                                        view,
                                                        result in
       print(NSLocalizedString("delete Tapped", comment: ""))
