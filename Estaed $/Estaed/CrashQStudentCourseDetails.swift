...
class CrashQStudentCourseDetails : UIViewController {
  
 
  @IBOutlet weak var TeatcherNameQStudent: UILabel!
  ...
  func getDetailsOfCourses(){
    ...
    ref.child("courses").child("Qudrat").child("Crash").observe(.value) { (snapshot) in
