...
class TeacherCoursesTabelViewController : UIViewController {
...
//اضيف اسم بروتكول
extension TeacherCoursesTabelViewController : UITableViewDelegate,UITableViewDataSource ,MyCellDelegate
{
